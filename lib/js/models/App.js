...
(function($, _, Converter, CategoryMenu, ConversionWindow, Calculator, Conversions){
    ...
    _.extend(App.prototype, {
        init: function() {
            _.bindAll(this, '_handleToggleClick', '_handleSwipeLeft', '_handleSwipeRight', '_handleChangeActive', 'updateConversions', '_handlePercent', '_handleDigit', '_handleDecimal', '_handleClear', '_handleInvert', '_handleAdd', '_handleSubtract', '_handleDivide', '_handleMultiply', '_handleEvaluate');
            ...
            console.log(self.converter.getTypes());
        ...
        _handleInvert: function () {
            ...
            if(this.getSilentClear()) {
                self.conversion.setFromValue('-', true);
                self.setSilentClear(false);
            } else {
